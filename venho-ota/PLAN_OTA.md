...
- **Theo yêu cầu Harry (2026-07-13):** `/health` giờ không cần bearer token nữa (`onRequest` hook bỏ qua path này) — dùng cho health-check/process manager, không lộ thông tin nhạy cảm. Mọi route khác vẫn yêu cầu token như cũ.
